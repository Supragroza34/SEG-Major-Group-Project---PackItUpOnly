...
\textbf{React 18} and \textbf{Redux Toolkit} (JavaScript). The AI chatbot is powered by
\textbf{Gemini}. Data is persisted in \textbf{SQLite} for development, with the architecture 
supporting migration to a production-grade relational database.