...
\textbf{React 18} and \textbf{Redux Toolkit} (JavaScript). Email integration is
provided by \textbf{Mailgun}, and the AI chatbot is powered by
\textbf{Ollama} running a \texttt{llama2} model locally. Data is persisted in
