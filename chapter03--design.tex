...
Persistent data is stored in an SQLite database during development and accessed through Django’s Object Relational Mapping (ORM) layer.
...
The backend is implemented using Django and Django REST Framework and is structured into several Django applications responsible for different areas of system functionality. The primary application, KCLTicketingSystems, contains the core logic of the ticketing platform, including ticket creation and management, user management, meeting request handling, and office hours management. An additional application, AIChatbot, provides an AI-powered support assistant using the Ollama framework. This module offers a chatbot interface that allows users to interact with an automated support system through a Django-rendered chat page and REST API endpoints.
