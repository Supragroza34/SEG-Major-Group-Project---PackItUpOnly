...
\textbf{Objective Prioritisation:} Among the various objectives, improving staff efficiency and ensuring query traceability were prioritised, as they directly address the primary bottleneck identified in the problem context. Enhancing student experience is treated as a dependent objective, expected to improve as a result of more efficient internal processes.
...
\textbf{Requirement Trade-offs:} Certain trade-offs were considered during requirement formulation. For example, introducing automated responses improves efficiency but risks reduced response quality, requiring careful balancing between automation and human oversight. Similarly, adding advanced analytics features could improve decision-making but would increase system complexity and maintenance effort.
